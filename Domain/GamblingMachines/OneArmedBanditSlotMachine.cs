...
public sealed class OneArmedBanditSlotMachine : AbstractSlotMachine<SlotCardTiles>
{
    ...
    private float GetTileMultiplier(SlotCardTiles tile)
    {
        return tile switch
        {
            ...
            SlotCardTiles.Two => 0.3f,
            SlotCardTiles.Three => 0.35f,
            SlotCardTiles.Four => 0.4f,
            SlotCardTiles.Five => 0.5f,
            SlotCardTiles.Six => 0.6f,
            SlotCardTiles.Seven => 7f,
            SlotCardTiles.Eight => 0.8f,
            SlotCardTiles.Nine => 0.9f,
            SlotCardTiles.Ten => 1f,
